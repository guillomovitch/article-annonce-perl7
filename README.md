...
sont capable de sortir une nouvelle version stable par an.
...
Evidement, des dents vont grincer, des fonctionalités vont disparaitre (notation indirecte,
syntaxe Perl4 des prototypes, ...) et une certaine inquiétude sur les
